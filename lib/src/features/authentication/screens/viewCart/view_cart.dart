    ...
    return Scaffold(
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Image(
                      image: AssetImage("assets/images/get_free_delivery.png")),
      ...
      bottomSheet: BottomSheet(onClosing: (){}, builder: (context) {
        return Container(
          ...
          child: Center(
            child: Text(
              "Choose address at next steps",style: TextStyle(fontSize: 15.sp,fontWeight: FontWeight.bold,fontFamily: "LibreFranklin"),
            ),
          ),
        );
      })
